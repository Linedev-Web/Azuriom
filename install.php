        ...
        if ($action === 'database') {
            ...
            if (array_key_exists($databaseType, $databasePorts)) {
                try {
                    ...
                    // SQLServer sometimes won't work with a port ?! It's just evil
...
<head>
  ...
  <link rel="icon" href="https://azuriom.com/install/assets/v0.2.3/img/logo.png">
  <title>Installation - Azuriom</title>
  <link href="https://azuriom.com/install/assets/v0.2.3/css/app.css" rel="preload" as="style">
  <link href="https://azuriom.com/install/assets/v0.2.3/css/chunk-vendors.css" rel="preload" as="style">
  <link href="https://azuriom.com/install/assets/v0.2.3/js/app.js" rel="preload" as="script">
  <link href="https://azuriom.com/install/assets/v0.2.3/js/chunk-vendors.js" rel="preload" as="script">
  <link href="https://azuriom.com/install/assets/v0.2.3/css/chunk-vendors.css" rel="stylesheet">
  <link href="https://azuriom.com/install/assets/v0.2.3/css/app.css" rel="stylesheet">
</head>
<body>
<noscript>
...
<div id="app"></div>
<script src="https://azuriom.com/install/assets/v0.2.3/js/chunk-vendors.js"></script>
<script src="https://azuriom.com/install/assets/v0.2.3/js/app.js"></script>
</body>
</html>
